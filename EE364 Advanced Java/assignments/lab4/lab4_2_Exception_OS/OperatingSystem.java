package lab4_2_Exception_OS;

import lab4_2_Exception.Calculator;
import lab4_2_Exception.Keyboard;
import lab4_2_Exception.OSTaskException;
import lab4_2_Exception.QWERTY;
...
public class OperatingSystem {
    ...
    public static void main(String[] args) throws OSTaskException, IOException {
        ...
        SpecialButtons[] SpecialButtonsList = {SpecialButtons.Backspace,
                          SpecialButtons.Load, SpecialButtons.Save};
        while (true) {
